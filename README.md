...
> [!NOTE]
>
> 在设置光猫的同时最好去掉光猫本身的 DHCP, 否则后续 IPTV 网关 DHCP获得 IP 时，猫自身的 DHCP 优先级会高于端口的 VLAN 85
>
> 由于无超密使用 ITV 口的用户基本都无法关闭猫自身的 DHCP，请在下文 [3.1 VLAN85 DHCP 获得 IP](#31-vlan85-dhcp-获得-ip) 进行操作时，记得查看 NOTE 部分。
